import { FileText, CheckCircle, Wrench, Bell, MapPin, Users, TrendingUp, Award, Sparkles, ArrowRight } from "lucide-react";
...
export default function Landing() {
  const issueCards = [
    ...
    },
    {
      ...
      location: "Satara‑Kolhapur Highway",
      status: "Resolved",
    ...
    <div className="min-h-screen bg-gradient-to-br from-orange-50 via-white to-amber-50 text-gray-900 overflow-hidden">
      ...
      <section id="home" className="relative min-h-screen flex items-center justify-center px-4 sm:px-6 lg:px-8 pt-10 sm:pt-24">
        <div className="max-w-7xl mx-auto text-center relative z-10">
          ...
          <h1 className="text-5xl sm:text-6xl lg:text-8xl font-bold mb-6 bg-gradient-to-r from-gray-900 via-gray-800 to-gray-600 bg-clip-text text-transparent leading-tight">
            Report Issues.
            <br />
          ...
          <p className="text-xl text-gray-600 mb-12 max-w-2xl mx-auto">
            Join a community of active citizens transforming neighborhoods, one step at a time.
          </p>
          ...
          <div className="mt-20 grid grid-cols-2 md:grid-cols-4 gap-4 max-w-4xl mx-auto">
            {stats.map((stat, index) => (
              <div key={index} className="bg-white/60 backdrop-blur-sm border border-gray-200/50 rounded-2xl p-6 hover:bg-white/80 hover:shadow-xl transition-all duration-300">
            ...
            {howItWorksSteps.map((step, index) => (
              <div key={index} className="relative group">
                <div className="relative bg-white/60 backdrop-blur-xl border border-gray-200/50 rounded-3xl p-8 hover:bg-white/80 hover:shadow-2xl transition-all duration-500 overflow-hidden">
                  ...
                  <div className="absolute top-4 right-4 text-6xl font-bold opacity-5 group-hover:opacity-10 transition-opacity text-gray-900">{index + 1}</div>
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-4 auto-rows-[200px]">
            {issueCards.map((issue, index) => {
              ...
              return (
                <div key={index} className={`${sizeClass} group cursor-pointer`}>
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-12">
            <div className="md:col-span-2">
              <div className="flex items-center gap-3 mb-4">
                <div className="w-10 h-10 rounded-full overflow-hidden shadow-lg shadow-[#ff9a47]/40">
                  <img src={Logo} alt="CivicFix Logo" className="w-full h-full object-contain" />
                </div>
              ...
              <p className="text-gray-600 max-w-sm">
                From awareness to action: building better communities together.
              </p>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-2 text-gray-600">
                <li className="text-sm">support@CivicFix.com</li>
          ...
          <div className="border-t border-gray-200 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
            <p className="text-gray-600 text-sm">
              &copy; 2026 CivicFix. All rights reserved.
            </p>
